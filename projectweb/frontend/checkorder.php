									...
									<!-- <div class="box space"></div> -->
										<!-- <div class="features"> -->
											...
											<!-- <div class="box2"> -->
												...
												<!-- <div class="img-resize"><span><img src="images/fox.jpg" alt="" /></span></div> -->
									...
									<!-- Elements -->
										...
										<div class="row gtr-200">
											<div class="col-6 col-12-medium">
												...
												<!-- <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Autem harum similique id eius! Esse, accusantium adipisci dolor ducimus voluptatem aut veniam, quam consequatur nihil iusto vero autem ipsum provident voluptas.</p> -->
												<!-- Text stuff -->
													<!-- <h3>Text</h3>
											...
											<div class="col-6 col-12-medium">
												...
												<form class="boxOrder">
													...
													<label for="fname">ราคารวม: 500 บาท</label>
													<label for="lname">ค่ามัดจำ 40% คิดเป็น: 200 บาท</label>
													<label for="lname">ราคาสุทธิ: 500 บาท</label>
													<a href="purchase.php" class="button secondary">ชำระเงิน</a>
